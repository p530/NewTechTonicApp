                        ...
                        <div id="login" class="animate form">
                            ...
                            <h3>TechTonic</h3>
                                ...
                                <p> 
                                    ...
                                    <input id="fname" name="email" required="required" type="text" placeholder="mymail@atmecs.com"/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd"> Password </label>
                                    <input id="fpass" name="pass" required="required" type="password" placeholder="eg. X8df!90EO" /> 
                                </p>
